                ...
                <div className="flex flex-col lg:flex-row justify-between items-end mb-32 gap-12">
                    <div className="space-y-8 max-w-3xl">
                        ...
                        >
                            ...
                            <span className="text-[10px] font-black uppercase tracking-[0.4em] italic">The Ecosystem Standard</span>
                        </motion.div>
                        <h2 className="text-5xl md:text-8xl font-black tracking-tight leading-[1.1] text-slate-950">
                            당신의 차량이<br />
                            <span className="text-blue-600">먼저 말을 거는</span><br className="hidden md:block" />
                            새로운 생태계
                        </h2>
                    </div>
                    <p className="text-xl text-slate-500 font-medium max-w-sm leading-relaxed border-l-2 border-slate-100 pl-8">
                        단순한 수리가 아닌 '공생'의 시작. 오즈카의 데이터 엔진이 당신의 주행을 넘어 자산의 가치를 설계합니다.
                    </p>
                </div>
                        ...
                        <div className="relative z-10 space-y-12">
                            <div className="inline-flex items-center gap-6">
                                ...
                                <div>
                                    ...
                                    <h3 className="text-4xl md:text-6xl font-black text-slate-950 tracking-tight italic">고유의 가치 증명</h3>
                                </div>
                            </div>
                            ...
                            <div className="space-y-6 max-w-xl">
                                ...
                                <p className="text-2xl text-slate-400 font-medium leading-relaxed">
                                    수리소의 불투명한 장막을 데이터로 제거합니다. AI가 정비사의 모든 공정을 감지하고, 그 결과를 블록체인 노드에 박제하여 당신만의 '절대 신뢰 이력'을 형성합니다.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            <div className="relative z-10 flex flex-col h-full justify-between">
                                ...
                                <div>
                                    ...
                                    <h4 className="text-3xl font-black mb-4 tracking-tighter">Liquid Asset<br /><span className="italic text-white/40">Value.</span></h4>
                                    <p className="text-base text-slate-400 font-medium leading-relaxed">기록이 곧 현금이 되는 경험. 중고차 시장 기준보다 15% 높은 가치를 보장받으세요.</p>
                                </div>
                            </div>
                            {/* Internal Glow */}
                        ...
                        >
                            <div className="relative z-10 h-full flex flex-col justify-between">
                                ...
                                <div>
                                    ...
                                    <h4 className="text-3xl font-black mb-4 tracking-tighter font-mono italic">Autonomous<br />Preservation</h4>
                                    <p className="text-base text-white/80 font-medium leading-relaxed">고장 전 미리 알려주는 예보 시스템. 당신의 수고를 0으로 수렴시킵니다.</p>
                                </div>
                            </div>

        ...
        <div className="bg-slate-950 rounded-[3rem] p-10 text-white shadow-2xl border border-white/5 relative overflow-hidden">
            ...
            <header className="flex justify-between items-center mb-10">
                <div>
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-widest text-slate-400">AI Certified Auction</span>
                    </div>
                ...
                <div className="flex flex-col items-end">
                    ...
                    <div className="text-[10px] text-slate-500 font-bold">Reliability Score: {trustScore}%</div>
                </div>
            </header>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-10">
                <div className="space-y-6">
                    <div>
                        <p className="text-[10px] font-black text-slate-500 uppercase mb-1">Current Highest Bid</p>
                    ...
                    <div>
                        <p className="text-[10px] font-black text-slate-500 uppercase mb-2">Auction Ends In</p>
                ...
                <div className="bg-white/5 rounded-[2rem] p-8 border border-white/5">
                    <p className="text-[10px] font-black text-slate-500 uppercase mb-4 text-center">Place Your AI-Verified Bid</p>
                    <div className="flex flex-col gap-4">
                        ...
                        >
                            {status === 'SUCCESS' ? <><ShieldCheck className="w-5 h-5" /> Bid placed successfully!</> :
                                status === 'BIDDING' ? 'Processing Bid...' :
            ...
            <div className="flex items-center gap-3 p-5 bg-white/5 rounded-2xl border border-white/5">
                ...
                <p className="text-[11px] text-slate-400 leading-relaxed">
                    This vehicle's value is backed by <span className="text-white font-bold">OZCAR DVA(Dynamic Value API)</span>.
                    Verified repairs have prevented a market decay of 12%.
                </p>
            </div>
        </div>
    );

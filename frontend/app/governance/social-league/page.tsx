...
const TABS = [
    { id: 'league', label: '?úÎùº?¥Îπô Î¶¨Í∑∏', icon: Trophy },
    { id: 'assets', label: '?êÏÖã ?ºÏ??¥Ïä§', icon: Star },
    { id: 'handshake', label: '?îÏ????∏Îìú?∞Ïù¥??, icon: Shield },
] as const;

type TabId = typeof TABS[number]['id'];

const STATS = [
    { label: 'Ï¥?Ï∞∏Ïó¨ ?úÎùº?¥Î≤Ñ', value: '28,412', icon: Users, color: 'text-blue-400' },
    { label: '?¥Î≤à Ï£?Î¶¨Í∑∏ Î≥¥ÏÉÅ', value: '142,000 OZP', icon: Trophy, color: 'text-amber-400' },
    { label: 'Í≤ÄÏ¶ùÎêú ?êÏΩî ?êÏàò', value: '98.4%', icon: TrendingUp, color: 'text-emerald-400' },
    { label: 'Í∏ÄÎ°úÎ≤å Î¶¨Ï†Ñ', value: '14Í∞úÍµ≠', icon: Globe, color: 'text-purple-400' },
];
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 py-16 md:py-24">
                    ...
                    >
                        ...
                        <p className="text-xl text-slate-400 max-w-2xl leading-relaxed">
                            ?§ÏãúÍ∞??úÎùº?¥Îπô Î¶¨Í∑∏?êÏÑú Í≤ΩÏüÅ?òÍ≥†, ?¨Í? ?êÏÖã???òÏßë?òÎ©∞, Í∏ÄÎ°úÎ≤å ?úÎùº?¥Î≤Ñ ?§Ìä∏?åÌÅ¨?Ä ?∞Í≤∞?òÏÑ∏??
                        </p>
                    </motion.div>
            ...
            <div className="border-t border-white/5 bg-gradient-to-r from-blue-900/20 to-purple-900/20">
                <div className="max-w-7xl mx-auto px-6 py-12 flex flex-col md:flex-row justify-between items-center gap-6">
                    <div>
                        ...
                        <h3 className="text-2xl font-black text-white">ÏßÄÍ∏?Î∞îÎ°ú Î¶¨Í∑∏??Ï∞∏Ïó¨?òÏÑ∏??/h3>
                        <p className="text-slate-400 mt-1">OBD ?∞Í≤∞ ???êÎèô?ºÎ°ú ??Çπ??Î∞òÏòÅ?©Îãà??</p>
                    </div>
                    <a

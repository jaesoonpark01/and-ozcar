            ...
            <div className="max-w-7xl mx-auto">
                        ...
                        >
                            <div className="text-center max-w-2xl mx-auto mb-16">
                                ...
                                <p className="text-slate-400 text-sm leading-relaxed">
                                    ?ïÏßÅ???ïÎπÑ Í∏∞Î°ù?Ä Í≥??òÏùµ???©Îãà?? ÎßàÏù¥???úÎ??àÏù¥?∞Î? ?µÌï¥ ?ïÎπÑ?¨Îãò??Î™ÖÏÑ± Í∞ÄÏπòÎ? ?ïÏù∏?òÏÑ∏??
                                </p>
                            </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                <div className="carbon-panel p-8 rounded-3xl border border-white/5">
                                    <h4 className="text-lg font-black italic text-white mb-4 uppercase">Step 1: ?êÏÇ∞??/h4>
                                    <p className="text-xs text-slate-500 leading-relaxed uppercase">?¨ÎùºÏßÄ??Í∏∞Ïà†??Î∏îÎ°ùÏ≤¥Ïù∏??Î∞ïÏ†ú?òÏó¨ ?ÅÍµ¨?ÅÏù∏ Î™ÖÏÑ± ?êÏÇ∞?ºÎ°ú ÎßåÎìú??ãú??</p>
                                </div>
                                <div className="carbon-panel p-8 rounded-3xl border border-white/5">
                                    <h4 className="text-lg font-black italic text-white mb-4 uppercase">Step 2: ÎßàÏù¥??/h4>
                                    <p className="text-xs text-slate-500 leading-relaxed uppercase">?ïÏßÅ??Í∏∞Î°ù ??Í±¥Ïù¥ OZC ?†ÌÅ∞ Î≥¥ÏÉÅ?ºÎ°ú ÏßÅÍ≤∞?òÎäî ?ïÏã§???òÏùµ ?ÑÎûµ??Í≤ΩÌóò?òÏÑ∏??</p>
                                </div>
                            </div>
                        </motion.div>
                    )}
                ...
                <ChurnPreventionModal
                    ...
                    onKeep={() => {
                        ...
                        alert("Íµ¨ÎèÖ???†Ï??¥Ï£º?îÏÑú Í∞êÏÇ¨?©Îãà?? OZP ?¨Ïù∏??2Î∞?Î∂Ä?§ÌåÖ???ÅÏö©?òÏóà?µÎãà??");
                    }}
                    onConfirmCancel={() => {
                        setShowChurnModal(false);
                        setIsSubscribed(false);
                        alert("Íµ¨ÎèÖ???¥Ï??òÏóà?µÎãà?? Î¨¥Î£å Î≤ÑÏ†Ñ??Í≥ÑÏÜç ?¥Ïö©??Ï£ºÏÑ∏??");
                    }}

                    ...
                    `}
                                    ...
                                    >
                                        <div className="absolute -top-10 left-1/2 -translate-x-1/2 whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity">
                                            <span className="bg-slate-900 text-white px-3 py-1 rounded-lg text-xs font-bold">??item.value}ë§?/span>
                                        </div>
                                    </div>
                    ...
                    <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
                        ...
                        <div className="space-y-6">
                            <div className="flex justify-between items-center">
                                ...
                                <span className="text-lg font-black text-emerald-500">+??85ë§?/span>
                            </div>

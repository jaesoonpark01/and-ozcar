          ...
          <div className="flex animate-ticker gap-20 text-[11px] font-black uppercase tracking-[0.6em] text-white/20 whitespace-nowrap">
            {[...Array(8)].map((_, i) => (
              <div key={i} className="flex items-center gap-20">
                <span className="flex items-center gap-6"><ShieldCheck className="text-blue-600" /> SECURED ASSETS: $1,250,000,000+</span>
                <span className="flex items-center gap-6"><Fingerprint className="text-indigo-600" /> ON-CHAIN VERIFIED RECORDS ONLY</span>
                <span className="flex items-center gap-6"><Zap className="text-amber-500 fill-current" /> PREDICTIVE POWER ACTIVE</span>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto space-y-20 relative z-20">
            ...
            >
              ...
              <h2 className="text-6xl md:text-[120px] font-black tracking-[-0.06em] leading-[1.1]">
                자동차의 수명을<br />
                <span className="italic uppercase text-blue-500">지휘하십시오.</span>
              </h2>
            </motion.div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-10">
              ...
              >
                지금 시작하기 <ArrowRight className="inline-block ml-4" />
              </motion.button>
            </div>
          </div>
        </section>

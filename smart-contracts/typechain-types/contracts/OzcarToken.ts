...
export interface OzcarTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
...
export interface OzcarToken extends BaseContract {
  connect(runner?: ContractRunner | null): OzcarToken;
  waitForDeployment(): Promise<this>;

  interface: OzcarTokenInterface;
